...
class PlannerServiceRequest(genpy.Message):
  _md5sum = "e02705efdc5c28a9850553465e8222a3"
...
"""
  ...
  _slot_types = ['string','string','float64[]','geometry_msgs/Pose[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.joints_input)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.joints_input))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.joints_input = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.pose_list = []
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.joints_input = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.pose_list = []
...
class PlannerService(object):
  ...
  _md5sum = 'bd117918dc567d7f32db6e895c8aadc5'
